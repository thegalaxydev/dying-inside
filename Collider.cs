...
namespace GameEngine
{
    public abstract class Collider
    {
        ...
        public bool CheckCollision(Actor other)
        {
            ...
            else if (other.CollisionVolume is BoxCollider)
            {
                return CheckCollisionBox((BoxCollider)other.CollisionVolume);
            }
        ...
        public abstract bool CheckCollisionBox(BoxCollider other);
